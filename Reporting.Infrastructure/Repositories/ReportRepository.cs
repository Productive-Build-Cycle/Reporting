    ...
    : IReportRepository
{
    ...
    {
        // This method is now deprecated in favor of ITeamPerformanceQuery implementations
        // Keeping for backward compatibility - delegates to EF implementation
        var efQuery = new Queries.EfTeamPerformanceQuery(_context);
        return await efQuery.ExecuteAsync(request, cancellationToken);
    }
